...
public class Validator {
	...
	public static boolean validate(String strToValidate) {
		...
		File schemaLocation = new File("D:\\уник\\КПП\\ArchiveCS\\Person.xsd");
		...
		try {
			...
			ServerStart.loggerServer.info(" is valid.");
		} catch (SAXException ex) {
			ServerStart.loggerServer.error(new String(" is not valid because " + ex.getMessage()));
			return false;
		}
		return true;
	}
